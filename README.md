...
<!-- add docker image support when submitting to PnP SPFx web part sample gallery -->
...
<!-- TODO: update download link once we submit to PnP SPFx web part sample gallery -->
...
<!-- TODO: when submitting to PnP web part sample repo I should update the image URL -->
